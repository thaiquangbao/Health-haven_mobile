        ...
        <ScrollView>
            ...
            <View style={{ flexWrap: 'wrap', flexDirection: 'column', width, gap: 10, paddingHorizontal: 20, paddingVertical: 10 }}>
              <View style={{ flexDirection: 'row',  width: '100%', alignItems: 'center'}}>
                <View style={{  position: 'absolute', right:130,width:30,height:30, backgroundColor: '#DD0000', borderRadius: 100}}>
                  <Text style={{ fontSize: 15, color: 'white', textAlign: 'center', marginTop: 4}}>{notifications.filter(item => item.seen === false).length}</Text>
                </View>
                <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Danh sách thông báo</Text>
              </View>
